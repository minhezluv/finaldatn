...
var TkYear = [
  {
    labelChart: ["Đi làm đúng giờ", "Đi làm muộn giờ"],
...
export default {
  ...
  methods: {
    async getStaffData() {
      await EmployeesAPI.GetInforPage(200, 1, "", "", "", 2)
        .then((response) => {
          console.log(response.data.length);
          this.stats[0].value = response.data.totalRecord;
        })
        .catch((e) => {
          console.log(e);
        });
    ...
    async getByYearAll() {
      await TK.getByYearAll(2023)
        .then((response) => {
          // console.log(response.data);
          // this.TkWeek.data = response.data;
          //  this.TkWeek.data = [0, 0, 1, 0, 0, 0, 0];
          ...
          console.log("TKYear: ", this.TkYear);
          this.IsLineLoad = true;
          console.log(this.IsLineLoad);
        })
        .catch((e) => {
          console.log(e);
        });

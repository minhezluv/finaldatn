<template>
  <div class="content__util">
    ...
    ></combobox>
    <combobox
      :customData="customContractData"
      style="margin-right: 20px"
      :model="'Tất cả hợp đồng'"
      @valueChanged="valueContractChanged"
    ></combobox>
    <combobox
...
export default {
  ...
  methods: {
    ...
    valueContractChanged(val, id) {
      console.log("val: ", val, id);
      this.$emit("contractCurrent", val, id);
    },
